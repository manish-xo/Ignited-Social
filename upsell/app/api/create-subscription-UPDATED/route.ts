...
export async function POST(req: NextRequest) {
  try {
    ...
    // This is also what lets the upsell page charge "on file" with one tap —
    // no need to re-enter card details for the add-on purchase.
    ...
    return NextResponse.json({
      ...
      customerId: customer.id, // NEW — needed by the upsell/success page
